...
см. пример монтирования такого блочного устройства в разделе "[Анализ зашифрованного раздела](../docs/02_security_demonstation.md#анализ-зашифрованного-раздела)".
